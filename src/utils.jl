...
function compute_theory_old(DL_TT, DL_TE, DL_EE, κ,#1
    ...
    #end
    TT_90_90   = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds_old(D_TT_90_90, A_80_cirrus, α_cirrus, β_cirrus,
    ...
    TT_90_150  = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds_old(D_TT_90_150, A_80_cirrus, α_cirrus, β_cirrus,
    ...
    TT_90_220  = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds_old(D_TT_90_220, A_80_cirrus, α_cirrus, β_cirrus,
    ...
    TT_150_150 = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds_old(D_TT_150_150, A_80_cirrus, α_cirrus, β_cirrus,
    ...
    TT_150_220 = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds_old(D_TT_150_220, A_80_cirrus, α_cirrus, β_cirrus,
    ...
    TT_220_220 = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds_old(D_TT_220_220, A_80_cirrus, α_cirrus, β_cirrus,
    ...
    EE_90_90   = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds_old(D_EE_90_90, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,1], ν_eff[2,1], SPT3G_windows_lmax)) ./
                                    _calibration(cal_E_90, cal_E_90, cal_E_90, cal_E_90)

    EE_90_150  = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds_old(D_EE_90_150, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,1], ν_eff[2,2], SPT3G_windows_lmax)) ./
                                    _calibration(cal_E_90, cal_E_150, cal_E_90, cal_E_150)

    EE_90_220  = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds_old(D_EE_90_220, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,1], ν_eff[2,3], SPT3G_windows_lmax)) ./
                                    _calibration(cal_E_90, cal_E_220, cal_E_90, cal_E_220)

    EE_150_150 = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds_old(D_EE_150_150, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,2], ν_eff[2,2], SPT3G_windows_lmax)) ./
                                    _calibration(cal_E_150, cal_E_150, cal_E_150, cal_E_150)

    EE_150_220 = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds_old(D_EE_150_220, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,2], ν_eff[2,3], SPT3G_windows_lmax)) ./
                                    _calibration(cal_E_150, cal_E_220, cal_E_220, cal_E_150)

    EE_220_220 = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds_old(D_EE_220_220, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,3], ν_eff[2,3], SPT3G_windows_lmax)) ./
                                    _calibration(cal_E_220, cal_E_220, cal_E_220, cal_E_220)


    TE_90_90   = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds_old(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,1], ν_eff[2,1], SPT3G_windows_lmax)) ./
                                    _calibration(cal_T_90, cal_E_90, cal_T_90, cal_E_90)

    TE_90_150  = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds_old(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,1], ν_eff[2,2], SPT3G_windows_lmax)) ./
                                    _calibration(cal_T_90, cal_E_150, cal_T_150, cal_E_90)

    TE_90_220  = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds_old(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,1], ν_eff[2,3], SPT3G_windows_lmax)) ./
                                    _calibration(cal_T_90, cal_E_220, cal_T_220, cal_E_90)

    TE_150_150 = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds_old(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,2], ν_eff[2,2], SPT3G_windows_lmax)) ./
                                    _calibration(cal_T_150, cal_E_150, cal_T_150, cal_E_150)

    TE_150_220 = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds_old(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,2], ν_eff[2,3], SPT3G_windows_lmax)) ./
                                    _calibration(cal_T_150, cal_E_220, cal_T_220, cal_E_150)

    TE_220_220 = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds_old(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,3], ν_eff[2,3], SPT3G_windows_lmax)) ./
...
function compute_theory(DL_TT, DL_TE, DL_EE, κ,#1
    ...
    ν_eff[1,1], ν_eff[1,1], A_80_cib, α_cib, β_cib, ν_eff[3,1], ν_eff[3,1], 1., 1., A_tSZ,
    ν_eff[5,1], ν_eff[5,1], ξ_tsz_CIB, A_kSZ, ℓs)) ./
    cross_calibration_mean(cal_T_90, cal_T_90, cal_T_90, cal_T_90)

    TT_90_150  = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds(D_TT_90_150, A_80_cirrus, α_cirrus, β_cirrus,
    ν_eff[1,1], ν_eff[1,2], A_80_cib, α_cib, β_cib, ν_eff[3,1], ν_eff[3,2], 1., 1., A_tSZ,
    ν_eff[5,1], ν_eff[5,2], ξ_tsz_CIB, A_kSZ, ℓs)) ./
    cross_calibration_mean(cal_T_90, cal_T_150, cal_T_90, cal_T_150)

    TT_90_220  = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds(D_TT_90_220, A_80_cirrus, α_cirrus, β_cirrus,
    ν_eff[1,1], ν_eff[1,3], A_80_cib, α_cib, β_cib, ν_eff[3,1], ν_eff[3,3], 1., 1., A_tSZ,
    ν_eff[5,1], ν_eff[5,3], ξ_tsz_CIB, A_kSZ, ℓs)) ./
    cross_calibration_mean(cal_T_90, cal_T_220, cal_T_90, cal_T_220)

    TT_150_150 = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds(D_TT_150_150, A_80_cirrus, α_cirrus, β_cirrus,
    ν_eff[1,2], ν_eff[1,2], A_80_cib, α_cib, β_cib, ν_eff[3,2], ν_eff[3,2], 1., 1., A_tSZ,
    ν_eff[5,2], ν_eff[5,2], ξ_tsz_CIB, A_kSZ, ℓs)) ./
    cross_calibration_mean(cal_T_150, cal_T_150, cal_T_150, cal_T_150)

    TT_150_220 = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds(D_TT_150_220, A_80_cirrus, α_cirrus, β_cirrus,
    ν_eff[1,2], ν_eff[1,3], A_80_cib, α_cib, β_cib, ν_eff[3,2], ν_eff[3,3], 1., 1., A_tSZ,
    ν_eff[5,2], ν_eff[5,3], ξ_tsz_CIB, A_kSZ, ℓs)) ./
    cross_calibration_mean(cal_T_150, cal_T_220, cal_T_220, cal_T_150)

    TT_220_220 = (DL_TT.+ssl_TT.+ab_TT.+TT_foregrounds(D_TT_220_220, A_80_cirrus, α_cirrus, β_cirrus,
    ν_eff[1,3], ν_eff[1,3], A_80_cib, α_cib, β_cib, ν_eff[3,3], ν_eff[3,3], 1., 1., A_tSZ,
    ν_eff[5,3], ν_eff[5,3], ξ_tsz_CIB, A_kSZ, ℓs)) ./
    cross_calibration_mean(cal_T_220, cal_T_220, cal_T_220, cal_T_220)


    EE_90_90   = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds(D_EE_90_90, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,1], ν_eff[2,1], ℓs)) ./
                                    cross_calibration_mean(cal_E_90, cal_E_90, cal_E_90, cal_E_90)

    EE_90_150  = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds(D_EE_90_150, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,1], ν_eff[2,2], ℓs)) ./
                                    cross_calibration_mean(cal_E_90, cal_E_150, cal_E_90, cal_E_150)

    EE_90_220  = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds(D_EE_90_220, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,1], ν_eff[2,3], ℓs)) ./
                                    cross_calibration_mean(cal_E_90, cal_E_220, cal_E_90, cal_E_220)

    EE_150_150 = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds(D_EE_150_150, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,2], ν_eff[2,2], ℓs)) ./
                                    cross_calibration_mean(cal_E_150, cal_E_150, cal_E_150, cal_E_150)

    EE_150_220 = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds(D_EE_150_220, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,2], ν_eff[2,3], ℓs)) ./
                                    cross_calibration_mean(cal_E_150, cal_E_220, cal_E_220, cal_E_150)

    EE_220_220 = (DL_EE.+ssl_EE.+ab_EE.+EE_foregrounds(D_EE_220_220, A_80_EE, α_EE, β_EE,
                                       ν_eff[2,3], ν_eff[2,3], ℓs)) ./
                                    cross_calibration_mean(cal_E_220, cal_E_220, cal_E_220, cal_E_220)


    TE_90_90   = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,1], ν_eff[2,1], ℓs)) ./
                                    cross_calibration_mean(cal_T_90, cal_E_90, cal_T_90, cal_E_90)

    TE_90_150  = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,1], ν_eff[2,2], ℓs)) ./
                                    cross_calibration_mean(cal_T_90, cal_E_150, cal_T_150, cal_E_90)

    TE_90_220  = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,1], ν_eff[2,3], ℓs)) ./
                                    cross_calibration_mean(cal_T_90, cal_E_220, cal_T_220, cal_E_90)

    TE_150_150 = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,2], ν_eff[2,2], ℓs)) ./
                                    cross_calibration_mean(cal_T_150, cal_E_150, cal_T_150, cal_E_150)

    TE_150_220 = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,2], ν_eff[2,3], ℓs)) ./
                                    cross_calibration_mean(cal_T_150, cal_E_220, cal_T_220, cal_E_150)

    TE_220_220 = (DL_TE.+ssl_TE.+ab_TE.+TE_foregrounds(A_80_TE, α_TE, β_TE,
                                       ν_eff[2,3], ν_eff[2,3], ℓs)) ./
                                    cross_calibration_mean(cal_T_220, cal_E_220, cal_T_220, cal_E_220)
